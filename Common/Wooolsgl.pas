...
//------------------------------------------------------------------------------
  Warning =
    '本程序仅供大家学习研究之用，不含任何商业成分。'#13#10 +
    '未经许可，任何企业或个人不得将之用于商业用途。'#13#10 +
    '对使用本程序可能引起的所有问题，本人概不负责。'#13#10 +
    '由Muzisoft06添加生成Wil文件功能，2006,06,07。'#13#10 +
    #09#09#09'作者'#09 + 'Game Sprite'#13#10 +
    #09#09#09'感谢'#09 + '谜の名侦探';
